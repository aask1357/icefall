...
def get_encoder_model(params: AttributeDict) -> nn.Module:
    ...
    encoder = Encoder(
        ...
        conv_post_norm=params.conv_post_norm,
        norm0=params.norm0,
        skip=params.skip,
...
def run(rank, world_size, args):
    ...
    param_groups = [no_wd, bias]
    if params.scale_small_lr:
        small_lr = {
        ...
        param_groups.append(small_lr)
    if params.channelwise_optim:
        channelwise = {
            "regex_list": [
        ...
        param_groups.append(channelwise)
