    ...
    def __init__(
        ...
        **kwargs
        ...
        self.quantizer_act = _ActQuantizer(
            n_bits_act, decay=decay, inplace=inplace, quantile=quantile,
            learnable_gamma=learnable_gamma, gamma_min=gamma_min, gamma_max=gamma_max
        )
        self.quantizer_weight = WeightQuantizer(
            n_bits_weight, eps=eps, decay=decay, mode=weight_quantizer_mode,
        )
...
class QuantizedEmbedding(ScaledEmbedding):
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(*args, **kwargs)
        self.quantizer = WeightQuantizer(n_bits_weight, eps=eps, decay=decay, mode=weight_quantizer_mode)
