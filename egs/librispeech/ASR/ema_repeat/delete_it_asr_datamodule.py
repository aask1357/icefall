...
class AsrDataModule:
    ...
    def add_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            type=str2bool,
            default=False,
            help="When enabled, use kpsonspeech-dev for validation.",
        )
        group.add_argument(
            "--data-ksponspeech-eval-clean",
            type=str2bool,
            default=False,
            help="When enabled, use kpsonspeech-eval-clean for validation.",
        )
        group.add_argument(
            "--data-ksponspeech-eval-other",
            type=str2bool,
            default=False,
            help="When enabled, use kpsonspeech-eval-other for validation.",
        )
        group.add_argument(
            "--data-zeroth-train",
            type=str2bool,
