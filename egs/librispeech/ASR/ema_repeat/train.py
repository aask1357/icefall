...
def add_model_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Number of repeats for each conv block.",
    )
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=False,
        help="Whether to share normalization layers in repeated conv blocks.",
    )
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=False,
        help="Whether to use pre-normalization in each conv block.",
    )
...
def get_encoder_model(params: AttributeDict) -> nn.Module:
    encoder = Encoder(
        ...
        block_pre_norm=params.block_pre_norm,
    )
    return encoder
...
def run(rank, world_size, args):
    ...
    valid_dl_dict = datamodule.get_valid_dataloader_dict(args)
