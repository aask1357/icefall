...
with open("param.buf", 'wb') as f:
    ...
    w_x = w3 @ w1
    w_x_in = w3 @ w2
    fwrite(w_x[:256, :], "enc.conv_post.0.weight_low")
    fwrite(w_x_in[:256, :], "enc.conv_post.1.weight_low")
    fwrite(w_x[256:, :], "enc.conv_post.0.weight_high")
    fwrite(w_x_in[256:, :], "enc.conv_post.1.weight_hig")
