...
from icefall.iir.iir_2o import IIR2O
...
class ConvBlock(nn.Module):
    def __init__(
        ...
        **iir_kwargs
        ...
        self.depthwise = IIR2O(channels_hidden, **iir_kwargs)
    ...
    def __init__(
        ...
        **iir_kwargs
        ...
        for dilation in dilations:
            layer = ConvBlock(
                channels, channels_expansion, dilation,
                activation, activation_kwargs, norm, dropout, se_activation,
                scaled_conv, act_bal, zero_init_residual, se_gate, **iir_kwargs
            )
