...
def get_encoder_model(params: AttributeDict) -> nn.Module:
    ...
    encoder = Encoder(
        ...
        r_max=params.iir_r_max,
        bidirectional=params.iir_bidirectional,
        filtfilt=params.iir_filtfilt,
        unpad_delay=params.iir_unpad_delay,
    )
    return encoder
...
def run(rank, world_size, args):
    ...
    iir_params = {
        "regex_list": ["radius\\.weight", "theta\\.weight"],
        "clamp": False,
        "lr": params.initial_lr * params.iir_lr_ratio,
        "weight_decay": 0.0,
    }
    model_params = update_param_groups(model, [iir_params])
