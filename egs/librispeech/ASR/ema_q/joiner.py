...
class Joiner(nn.Module):
    def __init__(
        ...
        self.encoder_proj = ScaledLinear(encoder_dim, joiner_dim, n_bits=n_bits, eps=eps)
        self.decoder_proj = ScaledLinear(decoder_dim, joiner_dim, n_bits=n_bits, eps=eps)
        self.output_linear = ScaledLinear(joiner_dim, vocab_size, n_bits=n_bits, eps=eps)
