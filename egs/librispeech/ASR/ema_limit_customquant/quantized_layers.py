...
class QuantizedLinear(ScaledLinear):
    def __init__(
        ...
        **kwargs
        ...
        self.quantizer_act = ActQuantizer(n_bits_act, eps, inplace=inplace, mode=quantizer_mode, gamma=quantizer_gamma)
        self.quantizer_weight = Quantizer(n_bits_weight, eps, inplace=False, mode=quantizer_mode, gamma=quantizer_gamma)
...
class QuantizedEmbedding(ScaledEmbedding):
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(*args, **kwargs)
        self.quantizer = Quantizer(n_bits_weight, eps, inplace=False,
                                   mode=quantizer_mode, gamma=quantizer_gamma)
