...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0,
        help="""Reduce the logit for blank by this value.""",
    )
...
def main():
    ...
    if args.data_zeroth_test:
        cuts = datamodule.zeroth_test_cuts()
        testt_dl.append(datamodule.test_dataloaders(cuts))
        test_sets.append("zeroth")
    if args.data_ksponspeech_eval_clean:
        cuts = datamodule.ksponspeech_eval_clean_cuts()
        test_dl.append(datamodule.test_dataloaders(cuts))
        test_sets.append("ksponspeech-eval-clean")
    ...
    if args.data_reazonspeech_large_test:
        ...
        test_dl.append(datamodule.test_dataloaders(cuts))
        test_sets.append("reazonspeech-large-test")
